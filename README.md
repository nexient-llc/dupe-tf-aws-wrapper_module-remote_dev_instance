...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_security_group_dev_servers"></a> [security\_group\_dev\_servers](#module\_security\_group\_dev\_servers) | terraform-aws-modules/security-group/aws | ~> 4.17.2 |
